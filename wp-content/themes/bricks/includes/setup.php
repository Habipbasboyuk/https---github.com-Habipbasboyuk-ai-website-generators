...
class Setup {
	...
	public function __construct() {
		add_filter( 'language_attributes', [ $this, 'set_project_default_mode' ] );
	 ...
	 *
	 * Also set via JS, but this is needed to avoid FOUC on page load.
	 * Unavoidable for "auto" mode, but for "dark" mode we can set it server-side.
	 *
	 * @since 2.2
	 */
