...
class Element_Toggle_Mode extends Element {
	...
	public function render() {
		...
		if ( $project_default_mode === 'light' ) {
			echo '<span class="toggle light is-active">';
		} else {
			echo '<span class="toggle light">';
		}
		...
		if ( $project_default_mode === 'dark' ) {
			echo '<span class="toggle dark is-active">';
		} else {
			echo '<span class="toggle dark">';
		}
