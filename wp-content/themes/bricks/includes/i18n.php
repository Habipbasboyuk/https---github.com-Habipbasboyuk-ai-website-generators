...
class I18n {
	...
	public static function get_builder_i18n() {
		return [
			...
			'colorPaletteConvertAllColorsInfo'            => __( 'This palette contains colors that are not variable-based. Click the "Convert" icon above or next to a specific color below to convert them to CSS variables for use throughout your website.', 'bricks' ),
